    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(CMainActivity.this , CMain2Activity.class);
                startActivity(i);
            }
        });
        ...
        iv2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(CMainActivity.this , CMain3Activity.class);
                startActivity(i);
            }
        });
        iv3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(CMainActivity.this , CMain4Activity.class);
                startActivity(i);
            }
        });
        iv4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(CMainActivity.this , CMain5Activity.class);
                startActivity(i);
            }
        });
    }
